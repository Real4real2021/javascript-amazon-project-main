...
class Clothing extends Product {
  //'extends' lets the new 'Clothing' class inheriate all the properties and methods in the 'Products' class
  sizeChartLink;
...
// logThis();
// //Runs functions but allows us to set the value 'hello'
// logThis.call("hello");


// const object3 = {
//   method: () => {
//     console.log(this);//undefined, keeps the value it had outside the arrow function, allows "this" to be accessible outside the function
//   },
// };
...
export function laodProducts (fun) {
